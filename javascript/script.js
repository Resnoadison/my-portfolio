...
const modalViews = document.querySelectorAll('.services__modal'),
    ...
    //   });
      ...
      function scrollHeader(){
        ...
        // hwen the sscroll is greater than 200 viewport height, add the scroll-header class to the header tag
      ...
      function scrollUp(){
        ...
        // hwen scroll is higher  than 560 viewport height, add the show-scroll class to the a tag with the scroll
    ...
    // active / deactivate the theme manualy with the button
